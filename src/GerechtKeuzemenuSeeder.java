...
public class GerechtKeuzemenuSeeder {
    ...
    public ArrayList<GerechtVerwerker> getGerechtOptiesLijst(String typeGerecht) {
        ...
        for (GerechtVerwerker gerechtVerwerker : gerechtKeuzesSeeder()) {
    ...
    public static ArrayList<GerechtVerwerker> gerechtKeuzesSeeder() { //gerechten voor het keuzemenu
