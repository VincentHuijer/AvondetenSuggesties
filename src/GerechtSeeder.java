...
public class GerechtSeeder {
    public static Gerecht zoekGerecht(String name) { //Als je een naam bv. lasagne meegeeft kijkt zoekGerecht in alleGerechten naar een match.
    ...
    public static ArrayList<Gerecht> getAlleGerechten() {
        if (Gerecht.getAlleGerechten().size() == 0) {
            //pasta gerechten
            Collections.addAll(new Gerecht("Lasagne", new ArrayList<>()).getIngredienten(),  //Collections is voor het beheren van lijsten
        ...
        return Gerecht.getAlleGerechten();
    }
}
